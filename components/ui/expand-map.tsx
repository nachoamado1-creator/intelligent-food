...
const sizes = {
  sm: { collapsedW: 200, collapsedH: 110, expandedW: 280, expandedH: 200 },
  md: { collapsedW: 240, collapsedH: 140, expandedW: 360, expandedH: 280 },
} as const;

export function LocationMap({
  location = "Tandil, Argentina",
  coordinates = "37.3217° S, 59.1332° W",
  size = "md",
  className,
}: LocationMapProps) {
  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{
          width: isExpanded ? dims.expandedW : dims.collapsedW,
          height: isExpanded ? dims.expandedH : dims.collapsedH,
        }}
      ...
      >
        ...
        >
          <div className="flex items-start justify-between">
            ...
            <motion.div
              className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-foreground/5 backdrop-blur-sm"
              animate={{
          ...
          <div className="space-y-1">
            <motion.h3
              className={cn(
                "text-foreground font-medium tracking-tight text-pretty",
                size === "sm" ? "text-xs leading-tight" : "text-sm"
              )}
